                        ...
                        <div className="container-fluid">
                            <div className="row">
                                <div className="col-12 col-sm-6">
                                    <ProjectCard style={theme === 'light' ? {border:'2px solid #000 !important'}:{border:'2px solid #fff !important'}} image={ARB1} text="Academia Rosario Ballet" images={imagesArb} url="https://www.academiarosarioballet.com.ar">
                                        <p style={{margin:'4px'}}>
                            ...
                            <div className="row">
                                ...
                                <div className="col-12 col-sm-6">
                                    <ProjectCard image={META1} text="Meta Certification" images={imagesMeta} url="https://juanjfarina.github.io/CapstoneProject">
                                        <p style={{margin:'4px'}}>
